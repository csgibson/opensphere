...
// TODO (the others)
// I see... I see now. This is called in package.json by action compile:vendor-min, and included in all the apps.
// so we'd need to disable it so that _all_ apps can run.
// which means, long run, MRs to remove mention of vendor-min from all.
...
const tuiEditorResources = [
  ...
  // },
  {
    ...
    scripts: [
      'toastui-editor.js'
      // TODO (might need to add editor extensions in here?)
    ]
  }
];
